export const metadata = {
    title: "Create a CRUD Web App with Bun and Elysia - Gaurish's Blog",
    description:
        "Tutorial to create a CRUD (Create, Read, Update, Delete) web application using Bun and Elysia.js",
    openGraph: {
        title: "Create a CRUD Web App with Bun and Elysia - Gaurish's Blog",
        description:
            "Tutorial to create a CRUD (Create, Read, Update, Delete) web application using Bun and Elysia.js",
        images: [{ url: "/og/crud-web-app-with-bun-and-elysia" }],
    },
};
