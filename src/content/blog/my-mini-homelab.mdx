...
import pishot1 from "../../assets/blog/pi-shots/1.jpg"
import pishot2 from "../../assets/blog/pi-shots/2.jpg"
import pishot3 from "../../assets/blog/pi-shots/3.jpg"
import homepg from "../../assets/blog/homepage.png"
...
<Image src={homepg} alt="homepage" loading="lazy" />
...
<Image src={pishot1} alt="shot 1" loading="lazy" />
<Image src={pishot2} alt="shot 2" loading="lazy" />
<Image src={pishot3} alt="shot 3" loading="lazy" />
